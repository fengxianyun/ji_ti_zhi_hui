...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_dfc289cb7476165496825fa0d115d34e {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_dfc289cb7476165496825fa0d115d34e() {}
        ~__struct_compiled_op_dfc289cb7476165496825fa0d115d34e(void) {
            cleanup();
        }
        ...
        
{
    ...
    {Py_XINCREF(py_V3);}
        ...
        goto __label_4;}
            ...
            // This is a TypeError to be consistent with DEBUG_MODE
            // Note: DEBUG_MODE also tells the name of the container
            if (PyArray_TYPE((PyArrayObject*) py_V3) != NPY_INT8) {
                PyErr_Format(PyExc_TypeError,
                             "expected type_num %d (NPY_INT8) got %d",
                             NPY_INT8, PyArray_TYPE((PyArrayObject*) py_V3));
                {
        __failure = 4;
        if (!PyErr_Occurred()) {
            PyErr_SetString(PyExc_RuntimeError,
...
V1_stride0, V1_stride1
    ...
    std::vector< std::pair<int, int> >::reverse_iterator V1_loops_rit;
        ...
        V1_loops_rit = V1_loops.rbegin();
            int V1_stride_l1 = init_strides[1][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V1_stride_l0 = init_strides[1][V1_loops_rit->second];
            ++V1_loops_rit;
            
V3_iter = (npy_int8*)(PyArray_DATA(V3));
V1_iter = (npy_float32*)(PyArray_DATA(V1));
        ...
        { // begin loop 1
            npy_int8 &V3_i = * ( V3_iter+V3_stride_l1*ITER_1+V3_stride_l0*ITER_0);
npy_float32 &V1_i = * ( V1_iter+V1_stride_l1*ITER_1+V1_stride_l0*ITER_0);

            
        {
            
            V1_i = (npy_float32)V3_i;
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_dfc289cb7476165496825fa0d115d34e_executor(__struct_compiled_op_dfc289cb7476165496825fa0d115d34e* self) {
            return self->run();
        }

        static void __struct_compiled_op_dfc289cb7476165496825fa0d115d34e_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_dfc289cb7476165496825fa0d115d34e*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_dfc289cb7476165496825fa0d115d34e* struct_ptr = new __struct_compiled_op_dfc289cb7476165496825fa0d115d34e();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_dfc289cb7476165496825fa0d115d34e_executor), struct_ptr, __struct_compiled_op_dfc289cb7476165496825fa0d115d34e_destructor);
  return thunk; }
...
PyMODINIT_FUNC initdfc289cb7476165496825fa0d115d34e(void){
   import_array();
   (void) Py_InitModule("dfc289cb7476165496825fa0d115d34e", MyMethods);
}
