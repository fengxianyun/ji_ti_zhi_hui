...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_efe9f8842e17e64786fb0080e333b050 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_efe9f8842e17e64786fb0080e333b050() {}
        ~__struct_compiled_op_efe9f8842e17e64786fb0080e333b050(void) {
            cleanup();
        }
...
// Op class Elemwise
        ...
        goto __label_9;}
            ...
            if((PyArray_ISCONTIGUOUS(V5) && PyArray_ISCONTIGUOUS(V7) && PyArray_ISCONTIGUOUS(V1)) || (PyArray_ISFORTRAN(V5) && PyArray_ISFORTRAN(V7) && PyArray_ISFORTRAN(V1))){
...
V7_iter = (npy_float32*)(PyArray_DATA(V7));
        ...
        for (int ITER_0 = 0; ITER_0<V7_n0; ITER_0++) {
            npy_float32 &V3_i = * ( V3_iter + ITER_0 * V3_jumpx_0 );
npy_float32 &V5_i = * ( V5_iter + ITER_0 * V5_jump0_0 );
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_efe9f8842e17e64786fb0080e333b050_executor(__struct_compiled_op_efe9f8842e17e64786fb0080e333b050* self) {
            return self->run();
        }

        static void __struct_compiled_op_efe9f8842e17e64786fb0080e333b050_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_efe9f8842e17e64786fb0080e333b050*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_efe9f8842e17e64786fb0080e333b050* struct_ptr = new __struct_compiled_op_efe9f8842e17e64786fb0080e333b050();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_efe9f8842e17e64786fb0080e333b050_executor), struct_ptr, __struct_compiled_op_efe9f8842e17e64786fb0080e333b050_destructor);
  return thunk; }
...
PyMODINIT_FUNC initefe9f8842e17e64786fb0080e333b050(void){
   import_array();
   (void) Py_InitModule("efe9f8842e17e64786fb0080e333b050", MyMethods);
}
