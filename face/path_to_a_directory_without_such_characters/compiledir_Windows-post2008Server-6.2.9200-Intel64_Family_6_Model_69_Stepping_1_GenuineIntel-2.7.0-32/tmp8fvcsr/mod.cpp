...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_834640bef852fe36ade028e56ee499c3 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_834640bef852fe36ade028e56ee499c3() {}
        ~__struct_compiled_op_834640bef852fe36ade028e56ee499c3(void) {
            cleanup();
        }
...
// Op class MakeVector
        ...
        npy_intp dims[1];
        dims[0] = 2;
        if(!V1 || PyArray_DIMS(V1)[0] != 2){
            Py_XDECREF(V1);
            V1 = (PyArrayObject*)PyArray_EMPTY(1, dims, PyArray_TYPE(V3), 0);
        }
        
            *((dtype_V1 *)PyArray_GETPTR1(V1, 0)) = *((dtype_V1 *) PyArray_DATA(V3));
            
            *((dtype_V1 *)PyArray_GETPTR1(V1, 1)) = *((dtype_V1 *) PyArray_DATA(V5));
            __label_7:
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_834640bef852fe36ade028e56ee499c3_executor(__struct_compiled_op_834640bef852fe36ade028e56ee499c3* self) {
            return self->run();
        }

        static void __struct_compiled_op_834640bef852fe36ade028e56ee499c3_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_834640bef852fe36ade028e56ee499c3*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_834640bef852fe36ade028e56ee499c3* struct_ptr = new __struct_compiled_op_834640bef852fe36ade028e56ee499c3();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_834640bef852fe36ade028e56ee499c3_executor), struct_ptr, __struct_compiled_op_834640bef852fe36ade028e56ee499c3_destructor);
  return thunk; }
...
PyMODINIT_FUNC init834640bef852fe36ade028e56ee499c3(void){
   import_array();
   (void) Py_InitModule("834640bef852fe36ade028e56ee499c3", MyMethods);
}
