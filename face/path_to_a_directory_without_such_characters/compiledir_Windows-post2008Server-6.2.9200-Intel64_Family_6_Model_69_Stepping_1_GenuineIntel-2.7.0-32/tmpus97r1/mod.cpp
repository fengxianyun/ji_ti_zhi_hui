...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_c39293dcd6230ed80e16c4ebdf09073f {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_c39293dcd6230ed80e16c4ebdf09073f() {}
        ~__struct_compiled_op_c39293dcd6230ed80e16c4ebdf09073f(void) {
            cleanup();
        }
...
// Op class Sum
        ...
        goto __label_5;}
                ...
                V3_jump0_1 = (V3_stride0) - (0);
                //printf("V3_jump0_1 is:");
                //std::cout << V3_jump0_1 << std::endl;
                
                V3_n1 = PyArray_DIMS(V3)[1];
                V3_stride1 = PyArray_STRIDES(V3)[1] / sizeof(npy_float32);
                V3_jump1_0 = (V3_stride1) - (V3_n0*V3_stride0);
                //printf("V3_jump1_0 is:");
                //std::cout << V3_jump1_0 << std::endl;
                ...
                
    {
        ...
        goto __label_5;}
                ...
                V1_jumpx_1 = -(0);
                //printf("V1_jumpx_1 is:");
                //std::cout << V1_jumpx_1 << std::endl;
                ...
                
    {
        ...
        if (!acc) {
            acc = (PyArrayObject*)PyArray_EMPTY(1, dims,
                                                    NPY_FLOAT64,
                                                    0);
        }
        else {
            ...
            if (!success) {
                ...
                PyErr_Clear();
                Py_XDECREF(acc);
                acc = (PyArrayObject*)PyArray_EMPTY(1, dims, NPY_FLOAT64, 0);
            }
        }
        if (!acc) {
            {
        ...
        goto __label_5;}
                ...
                acc_jumpx_1 = -(0);
                //printf("acc_jumpx_1 is:");
                //std::cout << acc_jumpx_1 << std::endl;
                
                acc_n0 = PyArray_DIMS(acc)[0];
                acc_stride0 = PyArray_STRIDES(acc)[0] / sizeof(npy_float64);
                acc_jump0_0 = (acc_stride0) - (0);
                //printf("acc_jump0_0 is:");
                //std::cout << acc_jump0_0 << std::endl;
...
acc_i = 0;
        for (int ITER_1 = V3_n0; ITER_1; ITER_1--) {
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_c39293dcd6230ed80e16c4ebdf09073f_executor(__struct_compiled_op_c39293dcd6230ed80e16c4ebdf09073f* self) {
            return self->run();
        }

        static void __struct_compiled_op_c39293dcd6230ed80e16c4ebdf09073f_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_c39293dcd6230ed80e16c4ebdf09073f*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_c39293dcd6230ed80e16c4ebdf09073f* struct_ptr = new __struct_compiled_op_c39293dcd6230ed80e16c4ebdf09073f();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_c39293dcd6230ed80e16c4ebdf09073f_executor), struct_ptr, __struct_compiled_op_c39293dcd6230ed80e16c4ebdf09073f_destructor);
  return thunk; }
...
PyMODINIT_FUNC initc39293dcd6230ed80e16c4ebdf09073f(void){
   import_array();
   (void) Py_InitModule("c39293dcd6230ed80e16c4ebdf09073f", MyMethods);
}
