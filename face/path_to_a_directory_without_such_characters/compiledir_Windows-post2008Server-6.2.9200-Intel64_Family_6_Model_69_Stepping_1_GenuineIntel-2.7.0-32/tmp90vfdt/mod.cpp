...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_3ef1d7a14c7b1fcb67af77d2566ea340 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_3ef1d7a14c7b1fcb67af77d2566ea340() {}
        ~__struct_compiled_op_3ef1d7a14c7b1fcb67af77d2566ea340(void) {
            cleanup();
        }
...
PyArrayObject * xview = NULL;
        ...
        goto __label_7;};
                ...
                xview_offset += PyArray_STRIDES(V3)[outer_ii] * start *
                       1;
                xview_dims[inner_ii] = slicelength;
                xview_strides[inner_ii] = PyArray_STRIDES(V3)[outer_ii] * step;
            ...
            else // tuple coord `outer_ii` is an int
            {
                ...
                if (idx >= 0)
                {
                    ...
                    {
                        xview_offset += PyArray_STRIDES(V3)[outer_ii] * idx *
                               1;
                    }
                    else
                    {
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_3ef1d7a14c7b1fcb67af77d2566ea340_executor(__struct_compiled_op_3ef1d7a14c7b1fcb67af77d2566ea340* self) {
            return self->run();
        }

        static void __struct_compiled_op_3ef1d7a14c7b1fcb67af77d2566ea340_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_3ef1d7a14c7b1fcb67af77d2566ea340*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_3ef1d7a14c7b1fcb67af77d2566ea340* struct_ptr = new __struct_compiled_op_3ef1d7a14c7b1fcb67af77d2566ea340();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_3ef1d7a14c7b1fcb67af77d2566ea340_executor), struct_ptr, __struct_compiled_op_3ef1d7a14c7b1fcb67af77d2566ea340_destructor);
  return thunk; }
...
PyMODINIT_FUNC init3ef1d7a14c7b1fcb67af77d2566ea340(void){
   import_array();
   (void) Py_InitModule("3ef1d7a14c7b1fcb67af77d2566ea340", MyMethods);
}
