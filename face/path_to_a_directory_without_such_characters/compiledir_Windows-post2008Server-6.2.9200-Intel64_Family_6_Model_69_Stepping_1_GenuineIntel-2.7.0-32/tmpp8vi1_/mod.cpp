...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_cdbd61cc4a5142cf86b298cbd344f443 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_cdbd61cc4a5142cf86b298cbd344f443() {}
        ~__struct_compiled_op_cdbd61cc4a5142cf86b298cbd344f443(void) {
            cleanup();
        }
...
// Op class Elemwise
        ...
        goto __label_11;}
                ...
                V9_stride0 = PyArray_STRIDES(V9)[0] / sizeof(npy_float32);
                V9_jump0_0 = (V9_stride0) - (0);
                //printf("V9_jump0_0 is:");
                //std::cout << V9_jump0_0 << std::endl;
        ...
        goto __label_11;}
            ...
            if((PyArray_ISCONTIGUOUS(V3) && PyArray_ISCONTIGUOUS(V7) && PyArray_ISCONTIGUOUS(V9) && PyArray_ISCONTIGUOUS(V1)) || (PyArray_ISFORTRAN(V3) && PyArray_ISFORTRAN(V7) && PyArray_ISFORTRAN(V9) && PyArray_ISFORTRAN(V1))){
            ...
            dtype_V1& V1_i = V1_ptr[i];
                        ...
                        {
npy_float32 V11_tmp1;
V11_tmp1 = V5_i * V7_i;
npy_float32 V11_tmp2;
V11_tmp2 = V3_i + V11_tmp1;
V1_i = V11_tmp2 - V9_i;
}
;
                    }
...
V9_iter = (npy_float32*)(PyArray_DATA(V9));
        ...
        for (int ITER_0 = 0; ITER_0<V9_n0; ITER_0++) {
            npy_float32 &V3_i = * ( V3_iter + ITER_0 * V3_jump0_0 );
npy_float32 &V5_i = * ( V5_iter + ITER_0 * V5_jumpx_0 );
npy_float32 &V7_i = * ( V7_iter + ITER_0 * V7_jump0_0 );
npy_float32 &V9_i = * ( V9_iter + ITER_0 * V9_jump0_0 );
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_cdbd61cc4a5142cf86b298cbd344f443_executor(__struct_compiled_op_cdbd61cc4a5142cf86b298cbd344f443* self) {
            return self->run();
        }

        static void __struct_compiled_op_cdbd61cc4a5142cf86b298cbd344f443_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_cdbd61cc4a5142cf86b298cbd344f443*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_cdbd61cc4a5142cf86b298cbd344f443* struct_ptr = new __struct_compiled_op_cdbd61cc4a5142cf86b298cbd344f443();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_cdbd61cc4a5142cf86b298cbd344f443_executor), struct_ptr, __struct_compiled_op_cdbd61cc4a5142cf86b298cbd344f443_destructor);
  return thunk; }
...
PyMODINIT_FUNC initcdbd61cc4a5142cf86b298cbd344f443(void){
   import_array();
   (void) Py_InitModule("cdbd61cc4a5142cf86b298cbd344f443", MyMethods);
}
