...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_d708110ee6a7a06fb2dd65c14562db4f {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_d708110ee6a7a06fb2dd65c14562db4f() {}
        ~__struct_compiled_op_d708110ee6a7a06fb2dd65c14562db4f(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_d708110ee6a7a06fb2dd65c14562db4f_executor(__struct_compiled_op_d708110ee6a7a06fb2dd65c14562db4f* self) {
            return self->run();
        }

        static void __struct_compiled_op_d708110ee6a7a06fb2dd65c14562db4f_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_d708110ee6a7a06fb2dd65c14562db4f*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_d708110ee6a7a06fb2dd65c14562db4f* struct_ptr = new __struct_compiled_op_d708110ee6a7a06fb2dd65c14562db4f();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_d708110ee6a7a06fb2dd65c14562db4f_executor), struct_ptr, __struct_compiled_op_d708110ee6a7a06fb2dd65c14562db4f_destructor);
  return thunk; }
...
PyMODINIT_FUNC initd708110ee6a7a06fb2dd65c14562db4f(void){
   import_array();
   (void) Py_InitModule("d708110ee6a7a06fb2dd65c14562db4f", MyMethods);
}
