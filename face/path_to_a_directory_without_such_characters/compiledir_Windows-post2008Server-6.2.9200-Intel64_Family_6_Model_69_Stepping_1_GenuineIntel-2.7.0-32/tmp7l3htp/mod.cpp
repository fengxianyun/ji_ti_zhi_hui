...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_3e6a4d870880531bd4a418135c7e48d8 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_3e6a4d870880531bd4a418135c7e48d8() {}
        ~__struct_compiled_op_3e6a4d870880531bd4a418135c7e48d8(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_3e6a4d870880531bd4a418135c7e48d8_executor(__struct_compiled_op_3e6a4d870880531bd4a418135c7e48d8* self) {
            return self->run();
        }

        static void __struct_compiled_op_3e6a4d870880531bd4a418135c7e48d8_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_3e6a4d870880531bd4a418135c7e48d8*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_3e6a4d870880531bd4a418135c7e48d8* struct_ptr = new __struct_compiled_op_3e6a4d870880531bd4a418135c7e48d8();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_3e6a4d870880531bd4a418135c7e48d8_executor), struct_ptr, __struct_compiled_op_3e6a4d870880531bd4a418135c7e48d8_destructor);
  return thunk; }
...
PyMODINIT_FUNC init3e6a4d870880531bd4a418135c7e48d8(void){
   import_array();
   (void) Py_InitModule("3e6a4d870880531bd4a418135c7e48d8", MyMethods);
}
