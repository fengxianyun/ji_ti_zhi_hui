...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_f9044b4fcb937e68c62ff1bb0d06cfc1 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_f9044b4fcb937e68c62ff1bb0d06cfc1() {}
        ~__struct_compiled_op_f9044b4fcb937e68c62ff1bb0d06cfc1(void) {
            cleanup();
        }
...
// Op class Elemwise
        ...
        goto __label_5;}
                ...
                V3_stride0 = PyArray_STRIDES(V3)[0] / sizeof(npy_int64);
...
V1_iter = (npy_float32*)(PyArray_DATA(V1));
        ...
        for (int ITER_0 = 0; ITER_0<V1_n0; ITER_0++) {
            npy_int64 &V3_i = * ( V3_iter + ITER_0 * V3_jump0_0 );
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_f9044b4fcb937e68c62ff1bb0d06cfc1_executor(__struct_compiled_op_f9044b4fcb937e68c62ff1bb0d06cfc1* self) {
            return self->run();
        }

        static void __struct_compiled_op_f9044b4fcb937e68c62ff1bb0d06cfc1_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_f9044b4fcb937e68c62ff1bb0d06cfc1*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_f9044b4fcb937e68c62ff1bb0d06cfc1* struct_ptr = new __struct_compiled_op_f9044b4fcb937e68c62ff1bb0d06cfc1();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_f9044b4fcb937e68c62ff1bb0d06cfc1_executor), struct_ptr, __struct_compiled_op_f9044b4fcb937e68c62ff1bb0d06cfc1_destructor);
  return thunk; }
...
PyMODINIT_FUNC initf9044b4fcb937e68c62ff1bb0d06cfc1(void){
   import_array();
   (void) Py_InitModule("f9044b4fcb937e68c62ff1bb0d06cfc1", MyMethods);
}
