...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_8a50e7937995fd7514df60733fb880eb {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_8a50e7937995fd7514df60733fb880eb() {}
        ~__struct_compiled_op_8a50e7937995fd7514df60733fb880eb(void) {
            cleanup();
        }
...
0, V9_stride1
    ...
    std::vector< std::pair<int, int> >::reverse_iterator V7_loops_rit;
        ...
        V7_loops_rit = V7_loops.rbegin();
            int V9_stride_l1 = init_strides[3][V7_loops_rit->second];
            ++V7_loops_rit;
            
            int V9_stride_l0 = init_strides[3][V7_loops_rit->second];
            ++V7_loops_rit;
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_8a50e7937995fd7514df60733fb880eb_executor(__struct_compiled_op_8a50e7937995fd7514df60733fb880eb* self) {
            return self->run();
        }

        static void __struct_compiled_op_8a50e7937995fd7514df60733fb880eb_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_8a50e7937995fd7514df60733fb880eb*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_8a50e7937995fd7514df60733fb880eb* struct_ptr = new __struct_compiled_op_8a50e7937995fd7514df60733fb880eb();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_8a50e7937995fd7514df60733fb880eb_executor), struct_ptr, __struct_compiled_op_8a50e7937995fd7514df60733fb880eb_destructor);
  return thunk; }
...
PyMODINIT_FUNC init8a50e7937995fd7514df60733fb880eb(void){
   import_array();
   (void) Py_InitModule("8a50e7937995fd7514df60733fb880eb", MyMethods);
}
