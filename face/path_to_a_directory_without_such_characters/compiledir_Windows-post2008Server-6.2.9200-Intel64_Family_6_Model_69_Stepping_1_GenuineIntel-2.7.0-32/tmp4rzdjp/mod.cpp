...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_10e165ccce24243672451608426d973e {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_10e165ccce24243672451608426d973e() {}
        ~__struct_compiled_op_10e165ccce24243672451608426d973e(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_10e165ccce24243672451608426d973e_executor(__struct_compiled_op_10e165ccce24243672451608426d973e* self) {
            return self->run();
        }

        static void __struct_compiled_op_10e165ccce24243672451608426d973e_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_10e165ccce24243672451608426d973e*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_10e165ccce24243672451608426d973e* struct_ptr = new __struct_compiled_op_10e165ccce24243672451608426d973e();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_10e165ccce24243672451608426d973e_executor), struct_ptr, __struct_compiled_op_10e165ccce24243672451608426d973e_destructor);
  return thunk; }
...
PyMODINIT_FUNC init10e165ccce24243672451608426d973e(void){
   import_array();
   (void) Py_InitModule("10e165ccce24243672451608426d973e", MyMethods);
}
