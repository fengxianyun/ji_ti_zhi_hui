...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_3e39449fa8fc7a0f4608363dc533626b {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_3e39449fa8fc7a0f4608363dc533626b() {}
        ~__struct_compiled_op_3e39449fa8fc7a0f4608363dc533626b(void) {
            cleanup();
        }
...
dims[1] = V3_n1;
        ...
        if (!V1) {
            V1 = (PyArrayObject*)PyArray_EMPTY(2, dims,
                                                    NPY_FLOAT32,
                                                    PyArray_ISFORTRAN(V3) && PyArray_ISFORTRAN(V5));
        }
        else {
...
V1_stride0, V1_stride1
    ...
    std::vector< std::pair<int, int> >::reverse_iterator V1_loops_rit;
        ...
        V1_loops_rit = V1_loops.rbegin();
            int V1_stride_l1 = init_strides[2][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V1_stride_l0 = init_strides[2][V1_loops_rit->second];
            ++V1_loops_rit;
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_3e39449fa8fc7a0f4608363dc533626b_executor(__struct_compiled_op_3e39449fa8fc7a0f4608363dc533626b* self) {
            return self->run();
        }

        static void __struct_compiled_op_3e39449fa8fc7a0f4608363dc533626b_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_3e39449fa8fc7a0f4608363dc533626b*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_3e39449fa8fc7a0f4608363dc533626b* struct_ptr = new __struct_compiled_op_3e39449fa8fc7a0f4608363dc533626b();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_3e39449fa8fc7a0f4608363dc533626b_executor), struct_ptr, __struct_compiled_op_3e39449fa8fc7a0f4608363dc533626b_destructor);
  return thunk; }
...
PyMODINIT_FUNC init3e39449fa8fc7a0f4608363dc533626b(void){
   import_array();
   (void) Py_InitModule("3e39449fa8fc7a0f4608363dc533626b", MyMethods);
}
