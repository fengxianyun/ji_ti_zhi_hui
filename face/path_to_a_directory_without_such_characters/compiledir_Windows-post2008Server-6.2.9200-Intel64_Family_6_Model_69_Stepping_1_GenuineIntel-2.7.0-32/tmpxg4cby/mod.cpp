...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_74f4a884f8b209f13500ef052c9b8ba4 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_74f4a884f8b209f13500ef052c9b8ba4() {}
        ~__struct_compiled_op_74f4a884f8b209f13500ef052c9b8ba4(void) {
            cleanup();
        }
...
dims[1] = V7_n1;
        ...
        goto __label_9;}
            ...
            if((PyArray_ISCONTIGUOUS(V7) && PyArray_ISCONTIGUOUS(V1)) || (PyArray_ISFORTRAN(V7) && PyArray_ISFORTRAN(V1))){
...
V1_stride0, V1_stride1
    ...
    std::vector< std::pair<int, int> >::reverse_iterator V1_loops_rit;
        ...
        V1_loops_rit = V1_loops.rbegin();
            int V1_stride_l1 = init_strides[3][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V1_stride_l0 = init_strides[3][V1_loops_rit->second];
            ++V1_loops_rit;
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_74f4a884f8b209f13500ef052c9b8ba4_executor(__struct_compiled_op_74f4a884f8b209f13500ef052c9b8ba4* self) {
            return self->run();
        }

        static void __struct_compiled_op_74f4a884f8b209f13500ef052c9b8ba4_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_74f4a884f8b209f13500ef052c9b8ba4*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_74f4a884f8b209f13500ef052c9b8ba4* struct_ptr = new __struct_compiled_op_74f4a884f8b209f13500ef052c9b8ba4();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_74f4a884f8b209f13500ef052c9b8ba4_executor), struct_ptr, __struct_compiled_op_74f4a884f8b209f13500ef052c9b8ba4_destructor);
  return thunk; }
...
PyMODINIT_FUNC init74f4a884f8b209f13500ef052c9b8ba4(void){
   import_array();
   (void) Py_InitModule("74f4a884f8b209f13500ef052c9b8ba4", MyMethods);
}
