...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_a0c0d004885b47900367b972585efa2a {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_a0c0d004885b47900367b972585efa2a() {}
        ~__struct_compiled_op_a0c0d004885b47900367b972585efa2a(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_a0c0d004885b47900367b972585efa2a_executor(__struct_compiled_op_a0c0d004885b47900367b972585efa2a* self) {
            return self->run();
        }

        static void __struct_compiled_op_a0c0d004885b47900367b972585efa2a_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_a0c0d004885b47900367b972585efa2a*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_a0c0d004885b47900367b972585efa2a* struct_ptr = new __struct_compiled_op_a0c0d004885b47900367b972585efa2a();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_a0c0d004885b47900367b972585efa2a_executor), struct_ptr, __struct_compiled_op_a0c0d004885b47900367b972585efa2a_destructor);
  return thunk; }
...
PyMODINIT_FUNC inita0c0d004885b47900367b972585efa2a(void){
   import_array();
   (void) Py_InitModule("a0c0d004885b47900367b972585efa2a", MyMethods);
}
