...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_b78ae86d3b913b592582a614c8701991 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_b78ae86d3b913b592582a614c8701991() {}
        ~__struct_compiled_op_b78ae86d3b913b592582a614c8701991(void) {
            cleanup();
        }
...
// Op class Elemwise
        ...
        goto __label_11;}
                ...
                V9_stride1 = PyArray_STRIDES(V9)[1] / sizeof(npy_float32);
                V9_jump1_1 = (V9_stride1) - (0);
                //printf("V9_jump1_1 is:");
                //std::cout << V9_jump1_1 << std::endl;
                
                V9_n0 = PyArray_DIMS(V9)[0];
                V9_stride0 = PyArray_STRIDES(V9)[0] / sizeof(npy_float32);
                V9_jump0_0 = (V9_stride0) - (V9_n1*V9_stride1);
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_b78ae86d3b913b592582a614c8701991_executor(__struct_compiled_op_b78ae86d3b913b592582a614c8701991* self) {
            return self->run();
        }

        static void __struct_compiled_op_b78ae86d3b913b592582a614c8701991_destructor(void* executor, void* self) {
            delete ((__struct_compiled_op_b78ae86d3b913b592582a614c8701991*)self);
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_b78ae86d3b913b592582a614c8701991* struct_ptr = new __struct_compiled_op_b78ae86d3b913b592582a614c8701991();
  ...
  PyObject* thunk = PyCObject_FromVoidPtrAndDesc((void*)(&__struct_compiled_op_b78ae86d3b913b592582a614c8701991_executor), struct_ptr, __struct_compiled_op_b78ae86d3b913b592582a614c8701991_destructor);
  return thunk; }
...
PyMODINIT_FUNC initb78ae86d3b913b592582a614c8701991(void){
   import_array();
   (void) Py_InitModule("b78ae86d3b913b592582a614c8701991", MyMethods);
}
