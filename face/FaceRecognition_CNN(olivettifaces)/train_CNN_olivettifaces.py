...
def evaluate_olivettifaces(learning_rate=0.05, n_epochs=200,
    ...
    epoch = 0
    done_looping = False
    print theano.printing.pydotprint(test_model, outfile="d://1.png", var_with_name_simple=True) 
    print theano.printing.pydotprint(validate_model, outfile="d://2.png", var_with_name_simple=True) 
    print theano.printing.pydotprint(train_model, outfile="d://3.png", var_with_name_simple=True) 
